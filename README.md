...
| Qwen3-30B-A3B | 17.7 GB | Q4_K_M | MoE (128 experts, K=8) | **19.0** | Strong, 141% of llama.cpp CPU |
| Qwen3.5-35B-A3B | 21.0 GB | Q4_K_M | SSM+MoE (256 experts) | **11.7** | Strong, 207% of llama.cpp CPU |
